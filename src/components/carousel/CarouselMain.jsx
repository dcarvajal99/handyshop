    ...
    <div id="controls-carousel" className="relative w-full" data-carousel="static">
      ...
      <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div className={activeIndex === 1 ? "duration-700 ease-in-out" : "hidden"} data-carousel-item>
          <img src={process.env.PUBLIC_URL + '../img/carousel/carousel-1.jpg'} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
        {/* Item 2 */}
        <div className={activeIndex === 2 ? "duration-700 ease-in-out" : "hidden"} data-carousel-item="active">
          <img src={process.env.PUBLIC_URL + '../img/carousel/carousel-2.jpg'} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
        {/* Item 3 */}
        <div className={activeIndex === 3 ? "duration-700 ease-in-out" : "hidden"} data-carousel-item>
          <img src={process.env.PUBLIC_URL + '../img/carousel/carousel-3.jpg'} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
        {/* Item 4 */}
        <div className={activeIndex === 4 ? "duration-700 ease-in-out" : "hidden"} data-carousel-item>
          <img src={process.env.PUBLIC_URL + '../img/carousel/carousel-4.jpg'} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
        {/* Item 5 */}
        <div className={activeIndex === 5 ? "duration-700 ease-in-out" : "hidden"} data-carousel-item>
          <img src={process.env.PUBLIC_URL + '../img/carousel/carousel-5.jpg'} className="absolute object-bottom block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
      </div>
      {/* Slider controls */}
