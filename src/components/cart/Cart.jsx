        ...
        <section  className="dark:bg-gray-900 h-full w-full">
            ...
            <div   className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                ...
                {cart.map((servicio) => (
                    <div key={servicio.id_servicio} className="rounded-lg md:w-2/3">
                        <div className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
                            <img src={servicio.img_url} alt="product-image" className="w-full rounded-lg sm:w-40" />
                ...
                <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                    ...
                    <button className="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600" onClick={clickRedireccion} >Check out</button>
                </div>
            </div>
        </section>
    );
